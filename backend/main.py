...
def create_agent(memory: ConversationBufferMemory) -> AgentExecutor:
    ...
    "- Step B: Ask the user for their email for the receipt. The email is MANDATORY.\n"
    ...
    "6) Starting a New Order (ONLY after Step 5 is fully completed):\n"
     "- This step cannot begin unless Step 5 has been finished — meaning the user’s email has been collected and place_order has been successfully executed.\n"
    "- If the user asks for a new order before completing Step 5, STOP and remind them:\n"
    "  'Let’s finish your previous order first. Could you please share your email address so I can confirm and send the receipt?'\n"
